...
async function handleLogin(event) {
    ...
    if (user) {
        ...
        showSuccessMessage(
            'Login Successful!',
            `Welcome back, ${user.fullname || user.username}! Redirecting to your dashboard...`
        );
...
function redirectToDashboard(role) {
    ...
    const url = dashboardUrls[role] || 'public-dashboard.html';
    
    // In a real application, you would redirect to the actual dashboard
    // For demo purposes, we'll show an alert
    alert(`Redirecting to ${role.toUpperCase()} Dashboard...\n\nIn a real application, you would be redirected to: ${url}`);
    
    // Simulate redirect
    console.log(`Redirecting to: ${url}`);
    
    // You can uncomment this line for actual redirection:
